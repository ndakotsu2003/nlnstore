				...
				<form action="" id="manage-sales">
					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-3">
							<label class="control-label">SIV</label>
								<input type="text" name="siv" value="" class= "form-control text-right" placeholder="SIV" id="siv">
								</div>
						</div>
						<hr>
						<div class="row mb-3">
							...
							<table class="table table-bordered" id="list">
								...
								<tbody>
									...
									?>
										<tr class="item-row">
											<td>
											<p class ="siv text-right"><?php echo $row['ref_no'] ?></p>
											</td>
											<td>
						...
						<div class="row">
							<button class="btn btn-primary btn-sm btn-block float-right " type="button" id="pay" onclick="$('#manage-sales').submit()" >Issue</button>
						</div>
					</div>
		...
		if($("#list .item-row").length <= 0){
			...
			success:function(resp){
				if(resp > 0){
					...
					setTimeout(function(){
						location.href = "index.php?page=issues"
					},1500)
				}
