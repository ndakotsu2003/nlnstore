...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			<button class="col-md-2 float-right btn btn-primary btn-sm" id="new_sales"><i class="fa fa-plus"></i> New Issue</button>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="card">
							...
							?>
								<tr>
									...
									<?php
										...
										$isaiah_inv = $conn->query("SELECT * FROM inventory where ref_no = '$inv_row' and type ='2'  ");
										while($row3=$isaiah_inv->fetch_assoc()):
											$product_id_product = $row3['product_id'];
										endwhile;



										$isaiah_inv1 = $conn->query("SELECT * FROM product_list where id = '$product_id_product'  ");
									...
									<td class="text-center">
										<a class="btn btn-sm btn-primary" href="index.php?page=pos3&id=<?php echo $row['id'] ?>">Edit</a>
...
<script>
	...
	$('#new_sales').click(function(){
		location.href = "index.php?page=pos3"
	})
